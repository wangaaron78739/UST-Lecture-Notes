...
\fancyhf{}
\rhead{\fancyplain{}{SOSC2990 Notes}}
\lhead{\fancyplain{}{\rightmark }}
\cfoot{\fancyplain{}{\thepage}}

\title{
{\LARGE SOSC2990 - Developmental Psychology} \\
\textbf{\large Taught by Beatrice Lai}\\
...
\begin{quote}
	\centering\small
    These are notes I typed in class, so there are probably a lot of typo/mistakes, so keep an eye out for anything that doesn't make sense.
\end{quote}
\tableofcontents
\newpage
\subfile{../2-5/2-5}
