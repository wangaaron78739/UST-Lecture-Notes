...
\newcommand{\vocab}[1]{\index{#1}\textbf{\color{blue} #1}}
...
\DeclareRobustCommand{\chii}{{\mathpalette\irchi\relax}}
...
\title{
{\LARGE MATH5412 - Advanced Probability Theory II} \\
\vspace*{0.5em}
{\large Aaron Wang}\\
\vspace*{-0.4em}
{\small\url{aswang@connect.ust.hk}}\\
{\large Spring 2022}\\
}
...
\abstract{These are notes for MATH5412 at HKUST, the second course in a two part graduate-level course taught by Bao Zhigang in Spring 2022. The main focus is as a continuation of MATH5411.}
