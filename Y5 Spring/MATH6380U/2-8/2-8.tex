...
\begin{definition}[\vocab{Time Average}]
...
\end{definition}
\begin{definition}[\vocab{Ensemble Average}]
...
We calculate the time average during \vocab{molecular dynamics (MD) simulations} and ensemble average during \vocab{Monte Carlo (MC) simulations}
